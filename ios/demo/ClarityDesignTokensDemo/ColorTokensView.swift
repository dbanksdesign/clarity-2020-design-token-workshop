...
struct ColorTokensView: View {
    ...
    var fontColors = [
        ...
        ColorToken(name: "colorFontInteractiveActive", value: ClarityDesignTokens.colorFontInteractiveActive),
        ColorToken(name: "colorFontInteractiveDisabled", value: ClarityDesignTokens.colorFontInteractiveDisabled),
